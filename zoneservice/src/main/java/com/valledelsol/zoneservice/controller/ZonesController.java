...
public class ZonesController {
    ...
    @GetMapping("/main")
    public ResponseEntity<ApiResponseDTO<ZoneResponseDTO>> findMainZone() {

        ZoneResponseDTO mainZone = zonesService.findMainZone();

        ApiResponseDTO<ZoneResponseDTO> responseDTO =
                new ApiResponseDTO<>(true, "Zona principal encontrada correctamente", mainZone);
